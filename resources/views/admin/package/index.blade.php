...
<div class="content-area py-1">
    ...
    <div class="container-fluid">
        ...
        <div class="box box-block bg-white">
            ...
            <h5 class="mb-1">Service Packages</h5>

            <a href="{{ route('admin.package.create') }}" style="margin-left: 1em;" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add New Package</a>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('admin.package.destroy', $package->id) }}" method="POST">
                                ...
                                {{ method_field('DELETE') }}
                                <a href="{{ route('admin.package.edit', $package->id) }}" class="btn btn-info btn-block">
