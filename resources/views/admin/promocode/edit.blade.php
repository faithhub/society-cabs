    ...
    <div class="container-fluid">
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.promocode.update', $promocode->id )}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					<label for="max_count" class="col-xs-2 col-form-label">Max Use</label>
					<div class="col-xs-10">
						<input class="form-control" type="number" value="{{ $promocode->max_count }}" name="max_count" required id="max_count" placeholder="Max Use">
					</div>
				</div>
				<div class="form-group row">
