            ...
            <table class="table table-striped table-bordered dataTable" id="table-2" style="width:100%;">
                ...
                @foreach($bank as $index => $service)
                    <tr>
                        ...
                        <td>
                                {{ csrf_field() }}
                                <a href="{{ route('admin.bank.approve', $service->id ) }}" class="btn shadow-box btn-success btn-rounded w-min-sm m-b-0-25 waves-effect waves-light" id="accountApproved" data="{{ $service->id }}">
                                     Approved
                                </a>
                            <!-- </form> -->
                        </td>
