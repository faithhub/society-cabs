...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            <h5 class="mb-1"><span class="s-icon"><i class="ti-stats-up"></i></span>  Disapproved Withdraw Request</h5>
            <hr/>
...
<div id="msg"></div>
      ...
      <div class="modal-footer">
        <a type="button" id="ApprovedId" class="btn btn-primary " onclick="DisApprovedId();"><span aria-hidden="true">Approve</a>
      </div>
    </div>
  </div>
</div>
    ...
    /* $('#approve_popup').click(function(){
        ...
        function DisApprovedId()
        {
            ...
            $.ajax({
                    ...
                    $("#msg").html('Withdraw Approved successfully');
