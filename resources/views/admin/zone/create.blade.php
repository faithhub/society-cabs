...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyALblVQFpwxYcfUfNlmkjZ9Wx_ukblPAiU&libraries=geometry,places,drawing&callback=initialize&ext=.js"></script>
...
function initialize() {
  ...
  searchBox.addListener('places_changed', function() {
    ...
    $("#peak_data").click(function(){  
      ...
      var data = {'_token': "JdtePtUBweqHBGcWKR1OMlPZiZ1fxBBThU0gQmcs",'day':day_p,'start_time':start_time_p,'end_time':end_time_p,'fare_in_percentage':peak_fare,'peak_night_type':'PEAK'};
      $.post("http://97pixelsdev.com/ilyft/admin/addpeakAnight", data, function(res) {
        // console.log(res);
     ...
     function removeRow (input) {
      input.parentNode.parentNode.remove()
        ...
        // alert(day_p+' '+start_time_p+' '+end_time_p+' '+peak_fare); 
        //   console.log($("#reg-form").serialize()); 
     var data = {'_token': "JdtePtUBweqHBGcWKR1OMlPZiZ1fxBBThU0gQmcs",'start_time':start_time_n,'end_time':end_time_n,'fare_in_percentage':night_fare,'peak_night_type':'NIGHT'};
...
$('#nightAdded').empty();
    ...
    var wId = null;
       ...
       $('#accountApproved').click(function(){
        ...
        $.ajax({
            ...
            url: 'http://97pixelsdev.com/ilyft/admin/approved_account?id='+id,
  ...
  methods: {
    ...
    getCountries: function(){
      ...
      axios.get('http://97pixelsdev.com/ilyft/admin/zone/getCountry', {
    ...
    getStates: function(){
      ...
      axios.get('http://97pixelsdev.com/ilyft/admin/zone/getState', {
    ...
    getCities: function(){
      axios.get('http://97pixelsdev.com/ilyft/admin/zone/getCity', { 
