...
<div class="col-md-12">
    <div class="dash-content">
        ...
        <div class="row no-margin payment">
            <div class="col-md-12">
                <h5 class="btm-border"><strong>@lang('user.Coupons')</strong> <a href="#" class="sub-right pull-right" data-toggle="modal" data-target="#add-promotion-modal">@lang('user.add_promocode')</a></h5>
                ...
                @empty
                <div class="pay-option">
                    <h6 class="text-center">@lang('user.no_available')</h6>
                </div>
                @endforelse
            </div>
        </div>
