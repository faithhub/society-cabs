						...
						<div class="tab-content">
							...
							<div class="tab-pane active" id="login">
								...
								<div class="col-md-6 col-sm-6">
									...
									<div class="col-md-6 col-sm-6">
										...
										<form style="margin-top: 20px;" class="login-frm" role="form" method="POST" action="{{ url('/login') }}"> 
							...
							<div class="tab-pane" id="register">
								...
								<div class="col-md-6 col-sm-6">
									...
									<form style="margin-top: 20px;" class="reg-frm" method="POST"  action="{{ url('/register') }}">
							...
							<div class="tab-pane" id="reset">
								...
								<div class="col-md-6 col-sm-6">
									...
									<form style="margin-top: 20px;" class="login-frm" role="form" method="POST" action="{{ url('/password/reset') }}"> 
										...
										<button type="submit" class="reg-btn">Get Reset Link<i class="fa fa-arrow-circle-right" aria-hidden="true" style="margin-left: 10px;"></i></button>
