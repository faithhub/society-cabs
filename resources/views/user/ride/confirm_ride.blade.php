...
<div class="dash-content">
    ...
    <div class="row no-margin">
        ...
        <div class="col-md-12">
            ...
            <h4 class="page-title">@lang('user.estimated_fare')</h4>
        ...
        <div class="col-md-5">
            ...
            {{ csrf_field() }}
                ...
                <dl class="dl-horizontal left-right">
                    ...
                    <dt>@lang('user.distance')</dt>

                    <dd>{{$fare->distance}} km</dd>

                    <dt>@lang('user.time')</dt>

                    <dd>{{$fare->time}}</dd>

                    <dt>@lang('user.tax_charges')</dt>

                    <dd>{{currency($fare->round_off)}}</dd>

                    <dt>@lang('user.price')</dt>

                    <dd>{{currency($fare->estimated_fare)}}</dd>
                    
                    <dt><h5>@lang('user.total')</h5></dt>
                ...
                @if($fare->surge == 1)
                    ...
                    <span><em>@lang('user.surge_extra')</em></span>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title">@lang('user.Schedule_a_ride')</h4>
      ...
      <div class="modal-body">
        ...
        <input value="{{date('m/d/Y')}}" data-provide="datepicker" type="text" id="datepicker" placeholder="Date" name="schedule_date">

        <label>@lang('user.time')</label>

        <input value="{{date('H:i')}}" data-provide="timepicker" type="text" id="timepicker" placeholder="Time" name="schedule_time">
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="schedule_button" class="btn btn-default" data-dismiss="modal">@lang('user.Schedule_trip')</button>
