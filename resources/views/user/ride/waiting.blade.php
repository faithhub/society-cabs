			...
			render: function(){
				return (
					...
					<input type="hidden" name="request_id" value={this.props.checkState.id} />
						...
						<h5><strong>@lang('user.ride.driver_info')</strong></h5>
						<div className="driver-details">
			            	<dl className="dl-horizontal left-right">
			...
			render: function(){
				...
				<div>
					...
					<br/>
		            	...
		            	<dl className="dl-horizontal left-right">
							<dt>@lang('user.distance_travelled')</dt>
                        	<dd>{this.props.checkState.distance} Km</dd>
                            <dt>@lang('user.time_taken')</dt>
                            ...
                            {this.props.checkState.payment.discount ?
								<span>
								<dt>@lang('user.ride.discount_applied')</dt>
