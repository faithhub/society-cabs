                    ...
                    <div class="container-fluid">
                        ...
                        <div class="navbar-header">
                            ...
                            <button type="button" class="hamburger is-closed" data-toggle="offcanvas">
                             ...
                             <a class="navbar-brand" href="<?php echo e(url('/')); ?>"><img src="{{ Setting::get('site_logo', '')  }}"></a>
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            ...
                            <!-- <ul class="nav navbar-nav">
                             ...
                             <ul class="nav navbar-nav">
                                ...
                                <li> <h3 class="banner-head2"><span class="strong">{{ Setting::get('site_title', 'Tranxit')  }}</h3></li>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a class="menu-btn" href="<?php echo e(url('/provider/register')); ?>">Become a Partner</a></li>
