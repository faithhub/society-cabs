        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6">
                <div class="f_widget about_widget text-center">
                    <a href="index.html" class="f_logo"><img style="height: 80px" src="https://ilikeride.com/public/uploads/9a1ad820e6a3d3936b3a8ef6d3f79124eb3b5276.png" alt="" style="margin-top: 10px;"></a>
