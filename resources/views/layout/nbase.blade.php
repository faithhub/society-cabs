...
<html lang="en">
  <head>
    ...
    <title>{{Setting::get('site_title','TaxiTime')}} - @yield('title') - Web Panel</title>
    <link rel="shortcut icon" type="image/png" href="{{ Setting::get('site_icon') }}"/>

    <link href="{{ asset('mainindex/css/bootstrap.css') }}" rel="stylesheet">

    <link href="{{ asset('mainindex/css/style.css') }}" rel="stylesheet">
