...

{
    ...
    public function estimated_fare(Request $request){
        ...
        try{
            ...
            return response()->json([
                    ...
                    'estimated_fare' => round($price,2), 

                    'distance' => round($kilometer,2),
                    ...
                    'isextraprice' => $isextraprice,
                    
                    'extraprice' => $extraprice,

                    'round_off' => round($tax_price, 2),

                    'eta_total' => round($total,2),
    ...
    public function add_promocode(Request $request) {
        ...
        try{
            ...
            }elseif($find_promo->max_count <= PromocodeUsage::where('promocode_id',$find_promo->id)->where('status','ADDED')->count()){
