...
class AccountBankResource extends Controller
{
    ...
    public function bank_approve($id){
        ...
        return back()->with('flash_success','Account Approved Successfully');
    ...
    $bank = WithdrawalMoney::where('status','DISAPPROVED')->get();
     return view('account.bank.disapproved_withdraw', compact('bank'));
      ...
      public function new_withdraw(Request $request)
    {
       ...
       $arr[0]['IFSC_code'] = $bankDetail->IFSC_code;
       $arr[0]['MICR_code'] = $bankDetail->MICR_code;
